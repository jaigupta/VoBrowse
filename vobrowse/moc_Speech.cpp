...
**
** Created: Thu Oct 18 13:43:38 2012
...
static const char qt_meta_stringdata_Speech[] = {
    "Speech\0"
};
...
const QMetaObjectExtraData Speech::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Speech::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Speech,
      qt_meta_data_Speech, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Speech::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Speech))
